...
<body class="font-sans text-gray-900">
  ...
  <div id="controlSection" class="container mx-auto p-6 hidden">
    <div class="flex items-center justify-between mb-8">
      ...
      <div class="flex">
  <button id="toggleMode" class="bg-teal-500 text-white px-4 py-2 rounded-lg btn hover:bg-teal-600 mx-2">
    <i class="fa-solid fa-sync mr-2"></i> Переключить режим
  </button>

  <div id="connectionIndicator" class="connection-indicator offline mx-2">
    <i class="fa-solid fa-wifi-slash"></i> Offline
  </div>

  <button id="logoutButton" class="logout-btn text-white px-4 py-2 rounded-lg mx-2">
